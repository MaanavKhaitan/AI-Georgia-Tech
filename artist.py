...
original_image = Image.open('/Users/maanavkhaitan/Downloads/square.jpg')
original_image = original_image.resize((height, width))

# Open and resize style image
style_image = Image.open('/Users/maanavkhaitan/Downloads/marilyn.jpg')
...
output_image.show()
output_image.save('resultpic.bmp')
